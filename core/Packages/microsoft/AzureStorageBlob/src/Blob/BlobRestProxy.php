...
namespace Core\Packages\microsoft\AzureStorageBlob\src\Blob;

use GuzzleHttp\Psr7;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Internal\IBlob;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Internal\BlobResources as Resources;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\AppendBlockOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\AppendBlockResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\BlobServiceOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\BlobType;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\Block;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\BlockList;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\BreakLeaseResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CommitBlobBlocksOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CopyBlobFromURLOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CopyBlobOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CopyBlobResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CreateBlobBlockOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CreateBlobOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CreateBlobPagesOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CreateBlobPagesResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CreateBlobSnapshotOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CreateBlobSnapshotResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CreateContainerOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\CreatePageBlobOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\UndeleteBlobOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\DeleteBlobOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\GetBlobMetadataOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\GetBlobMetadataResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\GetBlobOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\GetBlobPropertiesOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\GetBlobPropertiesResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\GetBlobResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\GetContainerACLResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\GetContainerPropertiesResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\LeaseMode;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\LeaseResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListBlobBlocksOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListBlobBlocksResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListBlobsOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListBlobsResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListContainersOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListContainersResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListPageBlobRangesDiffResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListPageBlobRangesOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\ListPageBlobRangesResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\PageWriteOption;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\PutBlobResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\PutBlockResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\SetBlobMetadataResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\SetBlobPropertiesOptions;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\SetBlobPropertiesResult;
use Core\Packages\microsoft\AzureStorageBlob\src\Blob\Models\SetBlobTierOptions;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\Authentication\SharedAccessSignatureAuthScheme;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\Authentication\SharedKeyAuthScheme;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\Authentication\TokenAuthScheme;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\Http\HttpFormatter;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\Middlewares\CommonRequestMiddleware;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\Serialization\XmlSerializer;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\ServiceRestProxy;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\ServiceRestTrait;
use Core\Packages\microsoft\AzureStorageCommon\src\Common\Internal\StorageServiceSettings;
...
use Core\Packages\microsoft\AzureStorageCommon\src\Common\SharedAccessSignatureHelper;
...
class BlobRestProxy extends ServiceRestProxy implements IBlob
{
    ...
    private function getContainerPropertiesAsyncImpl(
        ...
        if (is_null($options)) {
            $options = new BlobServiceOptions(null);
        }
    ...
    private function putLeaseAsyncImpl(
        ...
        Models\BlobServiceOptions $options,
        ?Models\AccessCondition   $accessCondition
    ) {
    ...
    private function updatePageBlobPagesAsyncImpl(
        ...
        if (is_null($options)) {
            $options = new CreateBlobPagesOptions(null);
        }
     ...
     */
    public function listContainers(ListContainersOptions|null $options)
    {
    ...
    public function listContainersAsync(
        ListContainersOptions|null $options
    ) {
        $method      = Resources::HTTP_GET;
        $headers     = array();
        $queryParams = array();
        ...
        if (is_null($options)) {
            $options = new ListContainersOptions(null);
        }
    ...
    public function createContainer(
        $container,
        ?Models\CreateContainerOptions $options
    ) {
    ...
    public function createContainerAsync(
        ...
        if (is_null($options)) {
            $options = new CreateContainerOptions(null);
        }
    ...
    public function setBlobTier(
        $container,
        $blob,
        ?Models\SetBlobTierOptions $options
    ) {
     ...
     */
    public function listBlobs($container, ?Models\ListBlobsOptions $options)
    {
    ...
    public function listBlobsAsync(
        $container,
        ?Models\ListBlobsOptions $options
    ) {
    ...
    public function createPageBlob(
        ...
        $blob,
        $length,
        ?Models\CreatePageBlobOptions $options
    ) {
    ...
    public function createAppendBlob(
        $container,
        $blob,
        ?Models\CreateBlobOptions $options
    ) {
    ...
    public function createBlockBlob(
        ...
        $blob,
        $content,
        ?Models\CreateBlockBlobOptions $options
    ) {
    ...
    public function createPageBlobFromContent(
        ...
        $length,
        $content,
        ?Models\CreatePageBlobFromContentOptions $options
    ) {
    ...
    public function appendBlock(
        ...
        $blob,
        $content,
        ?Models\AppendBlockOptions $options
    ) {
     ...
     * @return array
     */
    protected function createBlobBlockHeader(?Models\CreateBlobBlockOptions $options)
    {
        $headers = array();
        $this->addOptionalHeader(
            $headers,
    ...
    public function commitBlobBlocks(
        ...
        $blob,
        $blockList,
        ?Models\CommitBlobBlocksOptions $options
    ) {
    ...
    public function listBlobBlocks(
        $container,
        $blob,
        ?Models\ListBlobBlocksOptions $options
    ) {
    ...
    public function getBlobProperties(
        $container,
        $blob,
        ?Models\GetBlobPropertiesOptions $options
    ) {
    ...
    public function getBlobMetadata(
        $container,
        $blob,
        ?Models\GetBlobMetadataOptions $options
    ) {
    ...
    public function listPageBlobRanges(
        $container,
        $blob,
        ?Models\ListPageBlobRangesOptions $options
    ) {
    ...
    public function setBlobProperties(
        $container,
        $blob,
        ?Models\SetBlobPropertiesOptions $options
    ) {
    ...
    public function undeleteBlob(
        $container,
        $blob,
        ?Models\UndeleteBlobOptions $options
    ) {
    ...
    public function deleteBlob(
        $container,
        $blob,
        ?Models\DeleteBlobOptions $options
    ) {
    ...
    public function deleteBlobAsync(
        ...
        if (is_null($options)) {
            $options = new DeleteBlobOptions(null);
        }
    ...
    public function createBlobSnapshot(
        $container,
        $blob,
        ?Models\CreateBlobSnapshotOptions $options
    ) {
    ...
    public function copyBlobFromURL(
        ...
        $destinationBlob,
        $sourceURL,
        ?Models\CopyBlobFromURLOptions $options
    ) {
        return $this->copyBlobFromURLAsync(
            $destinationContainer,
            $destinationBlob,
    ...
    public function acquireLeaseAsync(
        ...
        return $this->putLeaseAsyncImpl(
            ...
            $options,
            $options->getAccessConditions() ?? null
        )->then(function ($response) {
    ...
    public function changeLeaseAsync(
        ...
        return $this->putLeaseAsyncImpl(
            ...
            is_null($options) ? new BlobServiceOptions(null) : $options,
            null
        )->then(function ($response) {
            return LeaseResult::create(
                HttpFormatter::formatHeaders($response->getHeaders())
