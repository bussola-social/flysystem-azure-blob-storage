...
interface IBlob
{
    ...
    */
    public function getServiceProperties(?ServiceOptions $options);
     ...
     * @see http://msdn.microsoft.com/en-us/library/windowsazure/hh452239.aspx
     */
    public function getServicePropertiesAsync(?ServiceOptions $options);
    ...
    */
     ...
     */
    public function getServiceStats(?ServiceOptions $options);
     ...
     * @see  https://docs.microsoft.com/en-us/rest/api/storageservices/get-blob-service-stats
     */
    public function getServiceStatsAsync(?ServiceOptions $options);
    ...
    */
    public function listContainers(?BlobModels\ListContainersOptions $options);
    ...
    public function listContainersAsync(
        ?BlobModels\ListContainersOptions $options
    );
    ...
    */
    public function createContainer(
        $container,
        ?BlobModels\CreateContainerOptions $options
    );
    ...
    */
    public function deleteContainer(
        $container,
        ?BlobModels\BlobServiceOptions $options
    );
    ...
    */
    public function listBlobs(
        $container,
        ?BlobModels\ListBlobsOptions $options
    );
    ...
    */
    public function createPageBlob(
        ...
        $blob,
        $length,
        ?BlobModels\CreatePageBlobOptions $options
    );
    ...
    public function createAppendBlob(
        $container,
        $blob,
        ?BlobModels\CreateBlobOptions $options
    );
    ...
    */
    public function createBlockBlob(
        ...
        $blob,
        $content,
        ?BlobModels\CreateBlockBlobOptions $options
    );
    ...
    public function createPageBlobFromContent(
        ...
        $length,
        $content,
        ?BlobModels\CreatePageBlobFromContentOptions $options
    );
    ...
    */
    public function createBlobBlock(
        ...
        $blockId,
        $content,
        ?BlobModels\CreateBlobBlockOptions $options
    );
    ...
    public function appendBlock(
        ...
        $blob,
        $content,
        ?BlobModels\AppendBlockOptions $options
    );
    ...
    */
    public function commitBlobBlocks(
        ...
        $blob,
        $blockList,
        ?BlobModels\CommitBlobBlocksOptions $options
    );
    ...
    */
    public function listBlobBlocks(
        $container,
        $blob,
        ?BlobModels\ListBlobBlocksOptions $options
    );
    ...
    */
    public function getBlobProperties(
        $container,
        $blob,
        ?BlobModels\GetBlobPropertiesOptions $options
    );
    ...
    */
    public function getBlobMetadata(
        $container,
        $blob,
        ?BlobModels\GetBlobMetadataOptions $options
    );
    ...
    */
    public function listPageBlobRanges(
        $container,
        $blob,
        ?BlobModels\ListPageBlobRangesOptions $options
    );
    ...
    public function setBlobTier(
        $container,
        $blob,
        ?BlobModels\SetBlobTierOptions $options
    );
    ...
    */
    public function setBlobProperties(
        $container,
        $blob,
        ?BlobModels\SetBlobPropertiesOptions $options
    );
    ...
    */
    ...
    public function saveBlobToFile(
        ...
        $container,
        $blob,
        ?BlobModels\GetBlobOptions $options
    );
    ...
    public function undeleteBlob(
        $container,
        $blob,
        ?BlobModels\UndeleteBlobOptions $options
    );
    ...
    */
    ...
    public function deleteBlob(
        $container,
        $blob,
        ?BlobModels\DeleteBlobOptions $options
    );
    ...
    */
    public function createBlobSnapshot(
        $container,
        $blob,
        ?BlobModels\CreateBlobSnapshotOptions $options
    );
    ...
    */
    public function copyBlob(
        ...
        $sourceContainer,
        $sourceBlob,
        ?BlobModels\CopyBlobOptions $options
    );
    ...
    public function copyBlobFromURL(
        ...
        $destinationBlob,
        $sourceURL,
        ?BlobModels\CopyBlobFromURLOptions $options
    );
